...
> 创作现代都市/快穿/穿越类网文时，除三大黄金法则外，必须遵守：

4. **即时感优先** - 内心戏用口语吐槽式，不用文学叙事腔；禁止"后来她才知道"等回顾性叙述
5. **落差制造幽默** - 身份落差（摄政王+集装箱）、语言落差（古人套现代框架）、行动落差（三言两语的反差反应）
6. **人物声音辨识度** - 每个角色说话方式有辨识度，不用看说话人标注就能判断是谁
7. **情感节制** - 高情绪时刻用具体动作代替情绪词；关键处留白，让读者填充

→ 详见 [internet-novel-style.md](references/guides/internet-novel-style.md)
